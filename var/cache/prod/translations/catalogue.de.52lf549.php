...
$catalogue = new MessageCatalogue('de', array (
  ...
  array (
    ...
    'unsupported_collation_explain' => 'Die konfigurierte Kollation <code>%s</code> ist auf Ihrem Server nicht verfügbar. Bitte installieren Sie sie (empfohlen) oder konfigurieren Sie einen anderen Zeichensatz und eine andere Kollation in der Datei <code>app/config/config.yml</code>.',
    'unsupported_engine' => 'Die konfigurierte Datenbank-Engine wird nicht unterstützt!',
    'unsupported_engine_explain' => 'Die konfigurierte Datenbank-Engine <code>%s</code> ist auf Ihrem Server nicht verfügbar. Bitte installieren Sie sie (empfohlen) oder konfigurieren Sie eine andere Datenbank-Engine in der Datei <code>app/config/config.yml</code>.',
    ...
    'engine_mismatch' => 'Die konfigurierte Datenbank-Engine unterstützt kein utf8mb4!',
    'engine_mismatch_explain' => 'Die konfigurierte Datenbank-Engine <code>%s</code> unterstützt kein utf8mb4. Bitte verwenden Sie stattdessen InnoDB oder konfigurieren Sie einen anderen Zeichensatz und eine andere Kollation in der Datei <code>app/config/config.yml</code>.',
    'innodb_large_prefix' => 'Die innodb_large_prefix-Option ist nicht aktiv!',
    'innodb_large_prefix_explain' => 'Die <code>innodb_large_prefix</code>-Option ist auf Ihrem Server nicht aktiv. Bitte aktivieren Sie sie (empfohlen) oder konfigurieren Sie einen anderen Zeichensatz und eine andere Kollation in der Datei <code>app/config/config.yml</code>.',
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'unsupported_collation_explain' => 'The configured collation <code>%s</code> is not available on your server. Please install it (recommended) or configure a different character set and collation in the <code>app/config/config.yml</code> file.',
    'unsupported_engine' => 'The configured database engine is not supported!',
    'unsupported_engine_explain' => 'The configured database engine <code>%s</code> is not available on your server. Please install it (recommended) or configure a different database engine in the <code>app/config/config.yml</code> file.',
    ...
    'engine_mismatch' => 'The configured database engine does not support utf8mb4!',
    'engine_mismatch_explain' => 'The configured database engine <code>%s</code> does not support utf8mb4. Please use InnoDB instead or configure a different character set and collation in the <code>app/config/config.yml</code> file.',
    'innodb_large_prefix' => 'The innodb_large_prefix option is not enabled!',
    'innodb_large_prefix_explain' => 'The <code>innodb_large_prefix</code> option is not enabled on your server. Please enable it (recommended) or configure a different character set and collation in the <code>app/config/config.yml</code> file.',
    'innodb_additional' => 'InnoDB is not configured properly!',
    'innodb_additional_explain' => 'Using large prefixes in MySQL versions prior to 5.7.7 and MariaDB versions prior to 10.2.2 requires the Barracuda file format and the <code>innodb_file_per_table</code> option.',
  ),
  'maintenance' => 
  array (
