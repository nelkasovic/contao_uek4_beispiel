...
class appContao_ManagerBundle_HttpKernel_ContaoKernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'user' => NULL, 'password' => NULL, 'dbname' => NULL, 'charset' => 'utf8mb4', 'driverOptions' => [], 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci', 'engine' => 'InnoDB']], new \Doctrine\DBAL\Configuration(), $a, []);
    }
    ...
    protected function getSchebTwoFactor_TrustedTokenStorageService($lazyLoad = true)
    {
        ...
        return new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\TrustedDeviceTokenStorage(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\JwtTokenEncoder('ThisTokenIsNotSoSecretChangeIt'), 'trusted_device', 5184000);
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'contao.encryption_key' => 'ThisTokenIsNotSoSecretChangeIt',
